...
def pdf(emp_data):
    ...
    value = emp_data['Employee_payslip_month']
    lines = []
    lines.append(value)
    ...
    total_standard_salary = np.sum([std_m_salary, std_m_hra,
                                    std_m_holiday, std_m_engagement_pay ,std_m_other])
    ...
    c.setFont("Helvetica-Bold", 9.5)
    c.drawString(410,height-575, f"April'{year}")
    c.drawString(410,height-590, f"May'{year}")
    c.drawString(410,height-605, f"June'{year}")
    c.drawString(410,height-620, f"July'{year}")
    c.drawString(410,height-635, f"August'{year}")
    c.drawString(410,height-650, f"September'{year}")
    c.drawString(410,height-665, f"October'{year}")
    c.drawString(410,height-680, f"November'{year}")
    c.drawString(410,height-695, f"December'{year}")
    c.drawString(410,height-710, f"January'{year}")
    c.drawString(410,height-725, f"February'{year}")
    c.drawString(410,height-740, f"March'{year}")
